  ...
  return (
    <div className="mb-4">
      <h3
        ...
        title={t('lista.estatisticasIlustrativas')}
      >
        <Flame size={18} className="text-orange-500" /> {t('lista.top20')}
      </h3>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
        {songs.map((song, index) => (
          ...
          >
            <span className="w-6 text-center font-bold text-gray-500" aria-hidden="true">{t('comum.ordinal', { n: index + 1 })}</span>
